        ...
        for (let i=0; i<=iterations; i++){
            if (!i){
                ...
                const newAuction = {
                    ...
                    "ending_period_start_block": startAuction + convertToNumber(scheduledAuction.call.Value.args.duration),
                    "auction_end": startAuction + convertToNumber(scheduledAuction.call.Value.args.duration) + durationEndingPeriod,
